...
CFLAGS = -Wall -Wextra -O0 -iquote include -iquote include-prefixes `pkg-config --cflags glib-2.0`
LDFLAGS = -lcurl -lncurses -lpthread -Llibvim -lvim `pkg-config --libs glib-2.0` -lyaml-cpp
